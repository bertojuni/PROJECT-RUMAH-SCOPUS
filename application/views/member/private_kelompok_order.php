    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Konfrimasi Private Online Kelompok</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('member/order/bengkel_detail') ?>">Private Online Kelompok</a></li>
                ...
                <table class="table">
                  <form action="<?= base_url('member/order/private_online_individu_order_now') ?>" method="POST">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Category</td>
                        <td colspan="2">: Online Kelompok </td>
                        <input type="hidden" name="kategori" value="Online Kelompok ">
                      </tr>

                      <tr>
                        <td>Price</td>
                        <td colspan="2">: Rp.25.000.000,-</td>
                        <input type="hidden" name="harga" value="25000000">
                    </tbody>
