    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Konfirmasi Preparation Manuscript </h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('member/order/bengkel_detail') ?>">Preparation Manuscript </a></li>
              ...
              <div class="row">
                <table class="table">
                  <form action="<?= base_url('member/order/bengkel_order_now') ?>" method="POST">
                    ...
                    <tr>
                        <td>Category</td>
                        <td colspan="2">: Preparation Manuscript  </td>
                        <input type="hidden" name="kategori" value="Manuscript Preparation ">
                      </tr>

                      <tr>
                        <td>Price</td>
                        <td colspan="2">: Rp.2.500.000,-</td>
