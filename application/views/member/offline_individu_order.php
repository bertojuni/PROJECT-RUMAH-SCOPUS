    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Konfrimasi Private Offline Individu</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('member/order/bengkel_detail') ?>">Private Offline Individu</a></li>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="row">
                <table class="table">
                  <form action="<?= base_url('member/order/private_online_kelompok_order_now') ?>" method="POST">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Category</td>
                        <td colspan="2">: Offline Individu </td>
                        <input type="hidden" name="kategori" value="Offline Individu ">
                      </tr>
