    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Konfirmasi Order Bengkel Paper</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('member/order/bengkel_detail') ?>">Bengkel Paper</a></li>
                  ...
                  <form action="<?= base_url('member/order/bengkel_order_now') ?>" method="POST">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <tr>
                        <td>Category</td>
                        <td colspan="2">: Bengkel Paper </td>
                        <input type="hidden" name="kategori" value="Bengkel Paper">
                      </tr>
