                            ...
                            <div class="invoice p-3 mb-3">
                                ...
                                <div class="row invoice-info">
                                    <div class="col-sm-4 invoice-col">
                                        <?php echo form_open_multipart('member/tagihan/submit_payment_bengkel'); ?>
                                        <div class="form-group">
                                            <label for="pass"><i class="zmdi zmdi-lock">Kode Booking</i></label>
                                            <input type="text" name="id_order" id="id_order" />
                                            <input type="hidden" name="kategori" id="kategori" value = "Bengkel Paper/Manuscript Preperation"/>
                                        </div>
