    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">preparation Manuscript </li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <div class="container-fluid">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                  ...
                  <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                          &#10003;  Sunting artikel
                    <br>  &#10003;	Terjemahan (Bahasa Indonesia ke Inggris)
                    <br>  &#10003;	Proofread 
                    <br>  &#10003;	Pencarian referensi 
                    <br>  &#10003;	Sitasi 
                    <br>  &#10003;	Paraphrase 
                    <br>  &#10003;	Menurunkan tingkat plagiasi
             ...
             <div class="card">
              ...
              <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                <div class="card-body">
                  Rp. 2.500.000,-<small> / </small> Artikel
          ...
          <a class="btn btn-primary" href="<?= base_url('member/order/manuscript_order') ?>" role="button">Setuju & Order</a>
